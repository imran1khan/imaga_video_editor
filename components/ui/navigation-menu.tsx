...
const NavigationMenu = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.Root> & { ngClass?: String }
>(({ className,ngClass, children, ...props }, ref) => (
  ...
  >
    {children}
    <NavigationMenuViewport Classname={ngClass}/>
  </NavigationMenuPrimitive.Root>
))
